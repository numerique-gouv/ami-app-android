...
abstract class LocalStorageRepositoryProtocol() {
    ...
    abstract suspend fun readInt(key: String, secureLevel: KeyStoreManager.SecurityLevelType): Boolean
    abstract suspend fun readString(key: String, secureLevel: KeyStoreManager.SecurityLevelType): Boolean
