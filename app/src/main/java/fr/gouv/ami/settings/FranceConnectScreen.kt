...
@Composable
fun FranceConnectScreen(webViewViewModel: WebViewViewModel, onFcClick: () -> Unit) {
    ...
    BaseScreen(viewModel = webViewViewModel) {
        Column(
            ...
            PrimaryButton("Connexion") {
                ...
                webViewViewModel.currentUrl = url
                onFcClick()
            }
        }
    }
...
@Preview
@Composable
fun PreviewFranceConnectScreenLight() {
    AMITheme {
        FranceConnectScreen(viewModel()) {}
    }
}

@Preview(uiMode = Configuration.UI_MODE_NIGHT_YES)
@Composable
fun PreviewFranceConnectScreenDark() {
    AMITheme {
        FranceConnectScreen(viewModel()) {}
    }
}
